 ...
 * Route: GET /tools
 * Route: GET /tools?p=tiktok  (platform detail)
 */
...
<div class="tab-wrap">
  <div class="tabs">
    <button class="tab active" onclick="switchTab(this,'social')"><span class="tab-icon">📱</span>Social Money</button>
    <button class="tab" onclick="switchTab(this,'offline')"><span class="tab-icon">🏪</span>Offline Money</button>
    <button class="tab" onclick="switchTab(this,'top')"><span class="tab-icon">🏆</span>Top Tools</button>
  </div>
</div>
...
<div class="tab-content" id="tab-top">
  <div class="sec-head">🚀 Top Online Earning Tools</div>
  <div class="tool-list">
